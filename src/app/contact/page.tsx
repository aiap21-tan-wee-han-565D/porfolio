      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            I am always open to discussing new opportunities, collaborations, or interesting data science projects.
          </p>
        </div>
                ...
                <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4">
                  <div className="flex">
                    ...
                    <p className="text-green-800 dark:text-green-200">
                      Your email client should have opened. If not, you can reach me directly at {siteConfig.email}
                    </p>
                  </div>
                </div>
              )}
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <a href={siteConfig.social.email} className="text-blue-600 dark:text-blue-400 hover:underline">
                      {siteConfig.email}
                    </a>
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-700 rounded-lg p-6">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-4">
                I am open to freelance projects, consulting opportunities, and interesting data science collaborations.
              </p>
